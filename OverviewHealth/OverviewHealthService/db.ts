...
export class Counters
{
    constructor(
        public statTime: Date,
        public pctProcessorTime: number,
        public availableMBytes: number,
        public pctPagingFileUsage: number,
        public databaseConnections: number,
        public idleDatabaseConnections: number)
    {
