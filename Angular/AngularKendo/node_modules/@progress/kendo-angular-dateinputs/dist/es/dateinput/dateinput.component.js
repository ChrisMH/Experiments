...
import { addMonths, cloneDate, createDate, isEqual, lastDayOfMonth } from '@progress/kendo-date-math';
        ...
        if (changes.min || changes.max) {
            ...
            if (this.kendoDate && isEqual(this.value, this.kendoDate.getDateObject())) {
                this.resolvedPromise.then(function () {
                    //call ngChange to notify FormControl of the range change
