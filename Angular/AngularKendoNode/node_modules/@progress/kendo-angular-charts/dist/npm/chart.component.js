...
var ChartComponent = (function (_super) {
    ...
    function ChartComponent(configurationService, themeService, element, intl, ngZone, instanceEventService) {
        ...
        element.nativeElement._kendoExportVisual = _this.exportVisual.bind(_this);
    ...
    ChartComponent.prototype.ngOnDestroy = function () {
        ...
        delete this.element.nativeElement._kendoExportVisual;
        if (this.instance) {
     ...
     * @hidden
     */
    ChartComponent.prototype.onResize = function () {
        if (this.resizeRateLimit > 0) {
            this.resize();
        }
    };
    /**
