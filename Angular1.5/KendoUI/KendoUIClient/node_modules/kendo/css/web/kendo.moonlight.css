...
.k-mediaplayer-toolbar {
  background-color: rgba(74, 79, 91, 0.7);
}
/* icons */
.k-icon:hover,
...
.k-filebrowser .k-tile .k-i-file {
  background-image: url('Moonlight/imagebrowser.png');
...
.k-i-kpi-increase,
.k-i-kpi-open {
  background-image: url('Moonlight/sprite_kpi.png');
}
/* Border radius */
.k-block,
.k-button,
...
@media only screen and (-webkit-min-device-pixel-ratio: 1.2), only screen and (min-device-pixel-ratio: 1.2) {
  ...
  .k-mobile-list .k-edit-field [type=checkbox]:checked,
  .k-mobile-list .k-edit-field [type=radio]:checked {
    background-image: url('Moonlight/sprite_2x.png');
  ...
  .k-i-kpi-increase,
  .k-i-kpi-open {
    background-image: url('Moonlight/sprite_kpi_2x.png');
