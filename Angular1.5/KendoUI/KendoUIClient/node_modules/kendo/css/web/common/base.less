...
.k-group-indicator .k-link:hover span.k-i-sarrow-n { .sprite-position(0, -129px) }
.k-group-indicator .k-link:hover span.k-si-arrow-s,
.k-group-indicator .k-link:hover span.k-i-sarrow-s { .sprite-position(0, -159px) }
.k-group-indicator .k-button:hover span.k-group-delete, .k-group-indicator .k-button:hover span.k-i-group-delete { .sprite-position(2, 1) }
...
.k-si-arrow-n, .k-i-sarrow-n { .sprite-hoverable(0, -129px); }
.k-si-arrow-e, .k-i-sarrow-e { .sprite-hoverable(0, 9); }
.k-si-arrow-s, .k-i-sarrow-s { .sprite-hoverable(0, -159px); }
.k-si-arrow-w, .k-i-sarrow-w { .sprite-hoverable(0, 11); }
...
.k-i-expand, .k-plus, .k-plus-disabled, .k-i-plus, .k-i-plus-disabled { .sprite-hoverable(0, 12); }
.k-i-expand-w, .k-rtl .k-i-expand, .k-rtl .k-plus, .k-rtl .k-plus-disabled, .k-rtl .k-i-plus, .k-rtl .k-i-plus-disabled { .sprite-hoverable(0, 13); }
.k-i-collapse, .k-minus, .k-minus-disabled, .k-i-minus, .k-i-minus-disabled { .sprite-hoverable(0, 14); }
.k-i-collapse-w, .k-rtl .k-i-collapse, .k-rtl .k-minus, .k-rtl .k-minus-disabled, .k-rtl .k-i-minus, .k-rtl .k-i-minus-disabled { .sprite-hoverable(0, 15); }

.k-i-pencil, .k-edit, .k-i-edit { .sprite-hoverable(2, 0); }
.k-i-close, .k-delete, .k-group-delete, .k-i-delete, .k-i-group-delete { .sprite-hoverable(2, 1); }
.k-si-close { .sprite-hoverable(10, 5); }
.k-multiselect .k-delete, .k-multiselect .k-i-delete { .sprite-position(10, 5); }
.k-multiselect .k-state-hover .k-delete, .k-multiselect .k-state-hover .k-i-delete { .sprite-position(11, 5); }

.k-i-tick, .k-insert, .k-update, .k-i-insert, .k-i-update { .sprite-hoverable(2, 2); }
.k-check:checked,
.k-mobile-list .k-edit-field [type=checkbox],
.k-mobile-list .k-edit-field [type=radio] { .sprite-hoverable(2, 2); }

.k-i-cancel, .k-cancel, .k-denied, .k-i-denied { .sprite-hoverable(2, 3); }
.k-i-plus, .k-add, .k-i-add { .sprite-hoverable(2, 4); }
.k-i-funnel, .k-filter, .k-i-filter { .sprite-hoverable(2, 5); }
.k-i-funnel-clear, .k-clear-filter, .k-i-clear-filter { .sprite-hoverable(2, 6); }
...
.k-resize-se, .k-i-resize-se { .sprite-hoverable(2, 10); }

// .k-i-hbar { background-position: -38px -309px; }
// .k-i-vbar { background-position: -165px -6px; }

.k-i-calendar { .sprite-hoverable(2, 11); }
.k-i-clock { .sprite-hoverable(2, 12); }
.k-si-plus, .k-i-splus { .sprite-hoverable(2, 13); }
.k-si-minus, .k-i-sminus { .sprite-hoverable(2, 14); }
...
.k-viewHtml, .k-i-view-html { background-position: -288px -120px; }

.k-i-insert-n, .k-insert-top, .k-i-insert-top { .sprite-hoverable(10, 2); }
.k-i-insert-m, .k-insert-middle, .k-i-insert-middle { .sprite-hoverable(10, 3); }
.k-i-insert-s, .k-insert-bottom, .k-i-insert-bottom { .sprite-hoverable(10, 4); }
.k-drop-hint { background-position: 0 -326px; }

.k-i-note, .k-warning, .k-i-info, .k-i-success, .k-i-warning, .k-i-error { .sprite-hoverable(10, 15); }
...
.k-file, .k-i-file { .sprite-hoverable(0, 0); }
.k-i-folder-add, .k-addfolder, .k-i-add-folder { .sprite-hoverable(2, 17); }
.k-i-folder-up, .k-goup, .k-i-go-up { .sprite-hoverable(2, 18); }

.k-i-more { .sprite-hoverable(4, 2); }

.k-i-gantt-toggle { .sprite-hoverable(4, 15); }
...
.k-checkbox-label {
   position: relative;
   padding-left: @checkbox-size + 0.5em;
   vertical-align: middle;
   line-height: 0.875em;
   cursor: pointer;
}
