...
.k-ghost-splitbar,
.k-numerictextbox .k-state-active .k-select,
.k-pager-wrap .k-state-selected,
.k-scheduler-views li.k-state-selected,
.k-slider .k-draghandle.k-state-active,
...
.k-i-create-link:before,
.k-i-hyperlink:before {
  content: '\E672';
}
.k-i-hyperlinkremove:before,
.k-i-unlink:before {
  content: '\E673';
}
...
.k-pager-wrap .k-link + .k-pager-numbers,
...
.k-pager-wrap .k-pager-numbers li + li {
  margin-left: -1px;
}
...
.k-spreadsheet-toolbar .k-button[data-tool=alignment],
.k-spreadsheet-toolbar .k-button[data-tool=backgroundColor],
.k-spreadsheet-toolbar .k-button[data-tool=borders],
.k-spreadsheet-toolbar .k-button[data-tool=freeze],
.k-spreadsheet-toolbar .k-button[data-tool=merge],
.k-spreadsheet-toolbar .k-button[data-tool=textColor] {
  width: auto;
  min-width: 1.25em;
}
.k-spreadsheet-toolbar .k-widget[data-tool=fontSize] {
  width: 5rem;
}
.k-spreadsheet-toolbar .k-widget[data-tool=fontFamily] {
  width: 6rem;
}
.k-spreadsheet-toolbar .k-widget[data-tool=format] {
  width: 4rem;
}
...
.k-spreadsheet-sheets-items .k-item {
  display: -webkit-box;
  display: -ms-flexbox;
  display: -webkit-flex;
  display: flex;
...
.k-spreadsheet-sheets-items .k-link.k-spreadsheet-sheets-remove {
  margin-right: .5rem;
  margin-left: -0.5rem;
  padding: 0;
}
...
.k-slider .k-tick.k-first,
.k-slider .k-tick.k-last {
  -webkit-box-flex: 1;
  -ms-flex: 1;
  -webkit-flex: 1;
          flex: 1;
...
.k-slider .k-slider-items + .k-slider-track,
.k-slider .k-slider-selection {
  display: block;
  position: absolute;
}
...
.k-slider-horizontal .k-button-decrease {
  -webkit-box-ordinal-group: 0;
  -ms-flex-order: -1;
  -webkit-order: -1;
          order: -1;
}
.k-slider-horizontal .k-button-increase {
...
.k-slider-horizontal .k-slider-items + .k-slider-track {
  margin-top: -0.25em;
  top: 50%;
}
.k-slider-horizontal .k-slider-buttons .k-slider-items + .k-slider-track {
  left: 40px;
  right: 40px;
}
...
.k-slider-vertical .k-slider-wrap {
  -webkit-box-orient: vertical;
  -webkit-box-direction: normal;
  -ms-flex-direction: column;
  -webkit-flex-direction: column;
...
.k-slider-vertical .k-button-increase {
  -webkit-box-ordinal-group: 0;
  -ms-flex-order: -1;
  -webkit-order: -1;
          order: -1;
...
.k-slider-vertical .k-slider-items + .k-slider-track {
  margin-left: -0.25em;
  left: 50%;
}
.k-slider-vertical .k-slider-buttons .k-slider-items + .k-slider-track {
  top: 40px;
  bottom: 40px;
}
...
.k-combobox .k-state-focused .k-i-close,
.k-combobox .k-state-hover .k-i-close {
  display: block;
}
...
.k-compact .k-timepicker .k-select,
.k-timepicker.k-compact .k-select {
  padding: 0.25rem;
}
.k-datetimepicker {
  border-width: 0;
...
.k-compact .k-upload.k-upload-sync .k-upload-button,
.k-upload.k-compact.k-upload-sync .k-upload-button {
  margin: 0.25rem 0.5rem;
}
.k-compact .k-upload .k-dropzone,
.k-upload.k-compact .k-dropzone {
  padding: 0.25rem 0.5rem;
}
.k-compact .k-upload .k-upload-files .k-file,
.k-upload.k-compact .k-upload-files .k-file {
  padding: 0.125rem 0.5rem;
}
.k-compact .k-upload .k-upload-files .k-filename,
.k-upload.k-compact .k-upload-files .k-filename {
  margin-left: 0.5rem;
}
.k-upload-button {
  position: relative;
...
.k-dropzone .k-upload-status-total .k-icon {
  margin-left: 0.5rem;
}
...
.k-switch-on .k-switch-background,
.km-switch-on .km-switch-background {
  margin: 0!important;
  left: 0;
}
.k-switch-container,
...
.km-switch-handle {
  border-radius: .25rem;
  background-color: #fff;
  -webkit-box-shadow: 0 1px 0 1px #ccc, 0 -1px 0 1px #ccc;
          box-shadow: 0 1px 0 1px #ccc, 0 -1px 0 1px #ccc;
}
.k-switch-label-on,
.km-switch-label-on {
  color: #fff;
...
.k-scroller-pull .k-template {
  display: inline-block;
  min-width: 200px;
  text-align: left;
}
.k-load-more .k-icon,
.k-scroller-pull .k-icon {
  display: inline-block;
  height: 2rem;
  margin-right: 1rem;
  vertical-align: middle;
...
.k-scroller-release .k-icon {
  -webkit-transform: rotate(180deg);
  -ms-transform: rotate(180deg);
      transform: rotate(180deg);
}
.k-scroller-refresh .k-icon {
...
.k-vertical-scrollbar {
  height: 100%;
  right: 2px;
  top: 0;
}
.k-horizontal-scrollbar {
  width: 100%;
  left: 0;
  bottom: 2px;
}
...
.k-gantt-columns .k-nonwork-hour {
  background-color: rgba(55, 58, 60, 0.025);
}
.k-line {
  color: #9b9d9e;
...
.k-mediaplayer-titlebar {
  color: #fff;
  background-image: -webkit-linear-gradient(rgba(55, 58, 60, 0.7), rgba(55, 58, 60, 0));
  background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(55, 58, 60, 0.7)), to(rgba(55, 58, 60, 0)));
  background-image: linear-gradient(rgba(55, 58, 60, 0.7), rgba(55, 58, 60, 0));
}
.k-dialog {
  padding-top: 0;
  max-width: 100%;
...
.k-menu .k-menu-group .k-item > .k-link > .k-image {
...
.k-menu-group .k-item.k-state-hover > .k-link.k-state-active {
  color: #fff;
  background-color: #0275d8;
}
