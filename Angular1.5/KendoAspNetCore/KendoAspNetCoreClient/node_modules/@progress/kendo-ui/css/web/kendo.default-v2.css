...
.k-pager-wrap .k-state-selected:focus {
  -webkit-box-shadow: inset 0 0 0 2px #eb5b51;
...
.k-button.k-primary:focus {
  -webkit-box-shadow: 0 3px 4px 0 rgba(255, 99, 88, 0.06);
          box-shadow: 0 3px 4px 0 rgba(255, 99, 88, 0.06);
}
...
.k-filtercell > span {
  padding-right: -webkit-calc((1.42857em + 8px + 2px) + 8px);
  padding-right: calc((1.42857em + 8px + 2px) + 8px);
  position: relative;
