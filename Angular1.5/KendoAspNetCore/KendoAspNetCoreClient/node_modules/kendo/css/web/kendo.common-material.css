...
.k-grid-toolbar .k-button:hover .k-i-add {
  background-position: -48px -64px;
}
.k-grid-toolbar .k-update,
.k-grid-toolbar .k-button:hover .k-update,
.k-grid-toolbar .k-i-update,
.k-grid-toolbar .k-button:hover .k-i-update {
  background-position: -48px -32px;
}
.k-grid-toolbar .k-cancel,
.k-grid-toolbar .k-button:hover .k-cancel,
.k-grid-toolbar .k-i-cancel,
.k-grid-toolbar .k-button:hover .k-i-cancel {
...
.k-panelbar .k-numerictextbox .k-select .k-link span.k-i-arrow-n,
.k-pivot .k-numerictextbox .k-select .k-link span.k-i-arrow-n {
  background-position: 0 -3px;
}
.k-panelbar .k-numerictextbox .k-select .k-link span.k-i-arrow-s,
.k-pivot .k-numerictextbox .k-select .k-link span.k-i-arrow-s {
  background-position: 0 -35px;
}
.k-pivot .k-i-arrow-n {
  background-position: 0 -192px;
