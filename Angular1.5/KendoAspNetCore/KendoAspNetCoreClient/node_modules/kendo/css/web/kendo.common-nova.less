...
.k-button:active {
    ...
    .k-i-edit,
    &:not(.k-state-disabled):hover .k-i-edit {
    ...
    .k-i-delete,
    &:not(.k-state-disabled):hover .k-i-delete {
    ...
    .k-i-cancel,
    &:not(.k-state-disabled):hover .k-i-cancel {
...
.k-toolbar {
    ...
    .k-button:active:not(.k-state-disabled) .k-justifyLeft {
        background-position: -265px -144px;
    }

    .k-state-active .k-justifyCenter,
    .k-button:active:not(.k-state-disabled) .k-justifyCenter {
        background-position: -265px -168px;
    }

    .k-state-active .k-justifyRight,
    .k-button:active:not(.k-state-disabled) .k-justifyRight {
        background-position: -265px -192px;
    }

    .k-state-active .k-bold,
    .k-button:active:not(.k-state-disabled) .k-bold {
        background-position: -265px 0;
    }

    .k-state-active .k-italic,
    .k-button:active:not(.k-state-disabled) .k-italic {
        background-position: -265px -24px;
    }

    .k-state-active .k-underline,
    .k-button:active:not(.k-state-disabled) .k-underline {
        background-position: -265px -48px;
    }

    .k-state-active .k-i-more,
    .k-button:active:not(.k-state-disabled) .k-i-more,
...
.k-primary {
    ...
    .k-i-insert,
    .k-i-update,
    &:not(.k-state-disabled):hover .k-i-update {
...
.k-grouping-header {
    ...
    .k-i-group-delete,
    .k-button-icon:hover > .k-icon.k-i-group-delete {
    ...
    .k-i-sarrow-n,
    .k-link:hover > .k-icon.k-i-sarrow-n {
    ...
    .k-i-sarrow-s,
    .k-link:hover > .k-icon.k-i-sarrow-s {
