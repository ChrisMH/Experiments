...
.km-meego .km-switch-container {
  overflow: hidden;
  border-radius: .8rem;
  background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(0, 0, 0, 0)), color-stop(98%, rgba(0, 0, 0, 0)), color-stop(98%, rgba(0, 0, 0, 0.2)));
...
.km-meego .km-switch-on .km-switch-wrapper {
  background: #1080DD;
  background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(255, 255, 255, 0.2)), color-stop(10%, rgba(255, 255, 255, 0.3)), color-stop(10%, rgba(255, 255, 255, 0)));
