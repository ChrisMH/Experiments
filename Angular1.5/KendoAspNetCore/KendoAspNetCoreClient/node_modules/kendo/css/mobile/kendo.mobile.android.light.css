...
.km-android .km-rowdelete {
  background-image: -webkit-gradient(linear, left top, left bottom, from(rgba(68, 68, 68, 0.5)), color-stop(50%, rgba(204, 204, 204, 0.5)), color-stop(50%, rgba(68, 68, 68, 0.1)), color-stop(50%, rgba(68, 68, 68, 0)));
