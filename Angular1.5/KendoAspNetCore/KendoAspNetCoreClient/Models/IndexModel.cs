    ...
    public class IndexModel
    {
        public IndexModel(HttpRequest request, IHostingEnvironment environment, AppSettings appSettings)
        {
            ...
            Styles = new HtmlBuilder
            {
                ...
                new LinkElem {Href = $"{PageConfig.RootUrl}css/kendo/kendo.common-2016.3.1118.css", Type = LinkType.Css, Rel = LinkRelType.Stylesheet},
                new LinkElem {Href = $"{PageConfig.RootUrl}css/kendo/kendo.bootstrap-2016.3.1118.css", Type = LinkType.Css, Rel = LinkRelType.Stylesheet},
